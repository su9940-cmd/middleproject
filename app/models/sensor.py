...
# Maps SensorReading's snake_case fields to the trained model's original
# column names. Use only when converting to the existing ML model's schema
# (see CLAUDE.md section 5) — never as the API/state field names themselves.
MODEL_COLUMN_MAP = {
    "temperature": "Temp",
    "pressure": "Pressure",
    "humidity": "Humidity",
