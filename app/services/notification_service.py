...
Slack Incoming Webhook을 사용한다. API 키/URL 같은 민감정보는 코드에 직접
작성하지 않고 환경 변수(SLACK_ALERT_WEBHOOK_URL)에서 읽는다.
"""
...
def send_alert(alert_id: str, machine_id: str, message: str) -> None:
    ...
    payload = {
        ...
        "blocks": [
            ...
            {
                "type": "context",
                "elements": [{"type": "mrkdwn", "text": f"alert_id: `{alert_id}` · machine_id: `{machine_id}`"}],
            },
        ],
    }
